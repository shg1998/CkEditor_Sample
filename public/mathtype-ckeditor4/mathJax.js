    ...
    if (!(window.MathJax && MathJax.Hub)) {
        ...
        MathJax.Hub = {
            config: {
                ...
                errorSettings: { message: ["[", ["MathProcessingError", "Math Processing Error"], "]"], style: { color: "#CC0000", "font-style": "italic" } },
                ignoreMMLattributes: {},
            },
            ...
            formatError: function (b, f) {
                ...
                var c = MathJax.HTML.Element("span", { className: "MathJax_Error", jaxID: "Error", isMathJax: true, id: b.MathJax.error.inputID + "-Frame" }, [["span", null, a]]);
        ...
        (function (d) {
            ...
            var g = MathJax.Object.Subclass(
                ...
                { id: "Jax", version: "2.7.4", directory: e + "/jax", extensionDir: e + "/extensions" }
            );
            b.InputJax = g.Subclass(
                ...
                { id: "InputJax", version: "2.7.4", directory: g.directory + "/input", extensionDir: g.extensionDir }
            );
            b.OutputJax = g.Subclass(
                ...
                { id: "OutputJax", version: "2.7.4", directory: g.directory + "/output", extensionDir: g.extensionDir, fontDir: e + (b.isPacked ? "" : "/..") + "/fonts", imageDir: e + (b.isPacked ? "" : "/..") + "/images" }
            );
            ...
            b.InputJax.Error = { id: "Error", version: "2.7.4", config: {}, sourceMenuTitle: ["Original", "Original Form"] };
        })("MathJax");
        (function (o) {
            var h = window[o];
            if (!h) {
